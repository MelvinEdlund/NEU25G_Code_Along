...
// Arimetiska operationer (räkneoperationer):
...
// Logiska operationer (Logic operators)
...
Console.WriteLine("\n z++ ökar z med 1 EFTER den skickas som argument till en metod.");
int z = 10;
Console.WriteLine(z);
Console.WriteLine(z++);
Console.WriteLine(z);
