...
// Referenece type
Person personA = new Person() { name = "Mel"};
Person personB = personA; //  Kopierar referensen till "Mel" till personB
...
Console.WriteLine($"PassValuetypeByValueReference(ref a) -> a = {a}\n");
