...
foreach (var animal in animals)
{
    ...
    // I detta fall kommer dock myCat bli null om det inte är en Cat.
    ...
    // The null conditional operator kan alltså användas istället för:
    ...
    // is-operatorn används för att se om animal är datatypen för Cat
    //if (animal is Cat)
    //{
    //    Cat myCat = (Cat)animal;
    //    myCat.Meow();
...
//myLong = 10000000000;
//myInt = (int)myLong;
//Console.WriteLine("Explicit konvertering: long => int (här krävs en cast");
//Console.WriteLine($"myLong = {myLong}");
//Console.WriteLine($"myInt = {myInt}");
...
class Cat : Mammal
{
    public void Meow()
    {
        Console.WriteLine($"{Name}: MEEOOOWW!!");
    }
