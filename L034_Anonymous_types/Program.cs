...
var person = new { FirstName = "Anders", LastName = "Svensoson", Age = 34 };
...
var people = new[]
{
    ...
    new { FirstName = "Fia", LastName = "Kvist", Age = 37 },
...
var user = new
{
    ...
    age = 45,
    contactInfo = new { eMail = "anders@gmail.com", phone = "0702348734" }
};
